...
#define W 32 // complete width of ac_std_float
#define E 8  // Exponent width of ac_std_float
...
float random_float(float maxValue = 20000.0) {
...
CCS_MAIN(int argc, char * argv[]) {
    ...
    for (int i=0; i<SIZE; i++) {
      ...
      array_in[i] = refarray_in[i];
        ...
        std::cout << "In: " << array_in[i].num << std::endl;
    ...
    for (int i=0; i<SIZE; i++){
        std::cout << "OUT: " << array_out[i].num << std::endl;
        std::cout << "REF: " << refarray_out[i] << "\n" << std::endl;
    }
