#ifndef ITERATIVE_MULTIPLICATION_H
#define ITERATIVE_MULTIPLICATION_H

#include "ac_int.h"



template<int W,bool T, int I>
class iter_mul_num{
    public:
    ...
    void iter_mul(const iter_mul_num<W, T, I> in_num1, const iter_mul_num<W, T, I> in_num2 , iter_mul_num<W, T> &num_out) {
        ...
        Iterative_MUL : for (int i = 0; i<I; i++){
                            ...
                            if( (place_of_one_1 == 0) || ( place_of_one_2 == 0) || temp_num1 == 0 || temp_num2 == 0 ){
